...
![image-20230814160221512](https://s2.loli.net/2023/08/14/Vtnj4sCQXYwmLzq.png)
...
![img](https://s2.loli.net/2023/08/14/Z1KmBlUSHf6GwgC.jpg)
...
![img](https://s2.loli.net/2023/08/14/7CwYPHc2BEjiVsM.gif)
...
![img](https://s2.loli.net/2023/08/14/YoRVcivf43jNqCl.jpg)
...
在开始讲解线程同步之前，我们需要先了解一下多线程情况下Java的内存管理(JMM)：

![img](https://s2.loli.net/2023/08/14/vNdZcMBhtrs62QJ.jpg)
...
![img](https://s2.loli.net/2023/08/14/bBi9F2hZROeaV4C.png)
...
![img](https://s2.loli.net/2023/08/14/9gqy5kuUoNTapjM.jpg)
...
守护进程是在计算机操作系统中运行的一种特殊类型的进程。守护进程在后台运行，独立于用户会话，并且通常没有直接的用户界面。守护进程通常被设计用于执行特定的系统任务或提供某种服务，而不是与用户交互。

不要把守护进程和守护线程相提并论！守护进程在后台运行运行，不需要和用户交互，本质和普通进程类似。而守护线程就不一样了，当其他所有的**非守护线程结束之后，守护线程是自动结束**，也就是说，Java中所有的线程都执行完毕后，守护线程自动结束，因此守护线程不适合进行IO操作，只适合打打杂：
...
[实战]: https://www.bilibili.com/video/BV1YP4y1o75f?p=129&amp;vd_source=2e87b0aa5bc3613c322738bf9ed03bff
